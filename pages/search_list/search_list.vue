	...
	<view class="height-100vh col background-color">
		...
		<view class="red-background-color" style="padding-bottom: 15upx;padding-top: 10upx;">
			...
			<view style="margin-left: 30upx;" class="row-no-full center-col">
				<input  v-model="item.keyword" @click="toSearch()" style="background-color: #FFFFFF;border-radius: 2rem;height: 50upx;flex: 1;padding-left: 20upx;" />
		...
		<view style="margin-top: 16upx;flex: 1;overflow: hidden;">
			...
			<scroll-view :scroll-y="true" style="height: 100%;">
				...
				<!-- 一行一个 -->
				<view v-if="type=='col'" v-for="v in 5" class="col" style="background-color: #FFFFFF;">

					<view style="padding: 30upx;">

						<view class="row-no-full">

							<image src="../../static/logo.png" style="width: 180upx;height: 180upx;"></image>
				...
				<view v-if="type=='row'" class="row-no-full space" style="flex-wrap: wrap;background-color: #F2F2F2;">
					...
					<view v-for="v in 10" style="width: 49%;background-color: #FFFFFF;margin-bottom: 15upx;border-radius: .3rem;" class="col">
						<view class="col" style="padding: 30upx;padding-bottom: 5upx;">

							<view class="row-no-full center-row">
								<image src="../../static/logo.png" mode="aspectFill" style="width: 100%;height: 160upx;"></image>
							</view>
							
							<view class="col">

								<text style="margin-top: 10upx;">西红柿 320g</text>
...
<script>
	export default {
		...
		onLoad(e) {
			...
			let keyword=decodeURI(e.keyword);
